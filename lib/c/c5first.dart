...
class c5first extends StatefulWidget{
  @override
  State<c5first> createState() => _c5firstState();
}

class _c5firstState extends State<c5first> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Concept and need of function'),),
      ...
      body:  SingleChildScrollView(
        child: Column(
          ...
          children: [
            Container(
              child: Center(child: Text('Concept and need of function',style: TextStyle(fontSize: 30 ,fontFamily: 'myfont'),)),
            ),
            Container(
              height: 30,
            ),
...
In making huge software the task can be divided into smaller ones and a function for each task can be written.
Functions are also used to perform repeated tasks.
