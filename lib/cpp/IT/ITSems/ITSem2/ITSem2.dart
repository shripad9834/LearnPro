...
class ITSem2 extends StatefulWidget {
  @override
  ITSem2State createState() => ITSem2State();
}

class ITSem2State extends State<ITSem2> {
  @override
          ...
          child:GridView.count(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('ECC',style: TextStyle(fontSize: 24 ,fontWeight: FontWeight.bold,) ,),
              ...
              InkWell(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('WPD',style: TextStyle(fontSize: 24 ,fontWeight: FontWeight.bold,) ,),
                ...
                onTap: (){
                  //  print('This is C++');
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>WPD()));
                },
              ),
            ],
          ),
