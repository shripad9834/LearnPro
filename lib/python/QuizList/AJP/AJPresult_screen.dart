...
import 'AJPquestionsummary.dart';
...
class AJPResultScreen extends StatelessWidget{

  const AJPResultScreen({
    super.key,
  ...
  List<Map<String,Object>> getSummaryData(){
    ...
    for (var i = 0; i < chooseAns.length; i++){
      summary.add({
        'quesion_index' : i + 1,
        'question' : AJPquesions[i].text,
        'correct_ans' : AJPquesions[i].answers[0],
  ...
  Widget build(BuildContext context) {
    ...
    final numTotalQuestions = AJPquesions.length;
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                AJPQuestionSummary(getSummaryData()),
