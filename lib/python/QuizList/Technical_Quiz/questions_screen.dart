...
class Questions_Screen extends StatefulWidget{
  Questions_Screen({super.key,required this.onSelectAns});

  final void Function(String ans) onSelectAns;

  @override
  State<Questions_Screen> createState() {
    return _Questions_Screen();
  }
}

class _Questions_Screen extends State<Questions_Screen>{
  ...
  Widget build(context){
    final currentQuestion = quesions[currentQuestionIndex];
