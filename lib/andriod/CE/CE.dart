...
import 'package:learnprogramming/andriod/CE/KCESem1/KCESem1.dart';
import 'package:learnprogramming/andriod/CE/KCESem2/KCESem2.dart';
          ...
          child:GridView.count(
            ...
            children: [
              InkWell(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => KCESem1()));
                },
              ),
              ...
              InkWell(
                ...
                onTap: (){
                  //  print('This is C++');
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>KCESem2()));
                },
              ),
