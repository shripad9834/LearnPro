...
import 'package:learnprogramming/andriod/CE/KCESem2/KCESem2Sub/Build&Con.dart';
import 'package:learnprogramming/andriod/CE/KCESem2/KCESem2Sub/EngMechanics.dart';
...
class KCESem2 extends StatefulWidget {
  @override
  KCESem2State createState() => KCESem2State();
}

class KCESem2State extends State<KCESem2> {
  @override
          ...
          child:GridView.count(
            ...
            children: [
              ...
              InkWell(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Engineering Mechanics',style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold,) ,),
                ...
                onTap: (){
                  //  print('This is C++');
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>EngMech()));
                },
              ),
              ...
              InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Center(child: Text('Buliding Material And Construction',style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold,) ,)),
                        ),
                      ),
                ...
                onTap: (){
                  //  print('This is C++');
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>BuildNCon()));
                },
              ),
