...
class KETCSem1 extends StatefulWidget {
  @override
  KETCSem1State createState() => KETCSem1State();
}

class KETCSem1State extends State<KETCSem1> {
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Communication Skills',style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold,) ,),
                      ),
