...
class KCMSem2 extends StatefulWidget {
  @override
  KCMSem2State createState() => KCMSem2State();
}

class KCMSem2State extends State<KCMSem2> {
  @override
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Padding(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 10),
                            child: Center(child: Text('Applied Mathematics',style: TextStyle(fontSize: 13 ,fontWeight: FontWeight.bold,) ,)),
                          ),
                        ),
                      ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Padding(
                          padding: const EdgeInsets.only(left: 10),
                          child: Center(child: Text('Enginnering Drawing',style: TextStyle(fontSize: 14 ,fontWeight: FontWeight.bold,) ,)),
                        ),
                      ),
