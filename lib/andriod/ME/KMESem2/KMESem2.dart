...
import 'package:learnprogramming/andriod/ME/KMESem2/KMESem2Sub/ManuTech.dart';
...
class KMESem2 extends StatefulWidget {
  @override
  KMESem2State createState() => KMESem2State();
}

class KMESem2State extends State<KMESem2> {
  @override
          ...
          child:GridView.count(
            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Applied Science',style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold,) ,),
              ...
              InkWell(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text('Manufacturing Technology',style: TextStyle(fontSize: 18 ,fontWeight: FontWeight.bold,) ,),
                      ),
                ...
                onTap: (){
                  //  print('This is C++');
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ManuTech()));
                },
              ),
